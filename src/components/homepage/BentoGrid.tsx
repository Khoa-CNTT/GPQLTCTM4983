...
export const BentoGridItem = ({
  ...
  header,
  icon,
  gradient = 'from-slate-50/95 to-white/90 dark:from-[#0d0e17]/90 dark:to-[#141623]/90'
}: {
  className?: string;
  ...
  return (
    <motion.div
      ...
      className={cn(
        'group/bento row-span-1 flex flex-col justify-between rounded-xl border border-slate-200 dark:border-gray-500/10 overflow-hidden backdrop-blur-md transition duration-300 hover:border-indigo-200 hover:shadow-md hover:shadow-indigo-100/20 dark:hover:border-indigo-500/10 dark:hover:shadow-indigo-500/5',
        className
      )}
    >
        ...
        <div className="p-4 pt-2">
          <div className="transition duration-300 group-hover/bento:translate-x-1">
            <div className="flex items-center gap-3 mb-2">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-indigo-50 to-white shadow-sm border border-indigo-100/40 transition-all duration-300 group-hover/bento:shadow-md dark:from-[#1e213a]/90 dark:to-[#171929]/90 dark:border-white/5">
                {icon}
              </div>
              <div className="font-sans text-base font-medium text-slate-800 dark:text-white/90">{title}</div>
            </div>
            <div className="font-sans text-sm leading-relaxed text-slate-600 dark:text-white/70">{description}</div>
          </div>
        </div>
      </div>
    </motion.div>
...
const items = [
  ...
  },
  {
    ...
    gradient: "from-cyan-50/95 to-sky-50/90 dark:from-[#0d0e17]/90 dark:to-[#141623]/90",
  },
];
