  ...
  return (
    <div className="relative min-h-screen w-full bg-gradient-to-b from-rose-50/20 via-white to-gray-50/70 dark:from-gray-950 dark:via-gray-900 dark:to-black">
      ...
      <div className="relative z-10">
          ...
          >
            ...
            <div className="mb-12 text-center">
              <motion.span
                ...
                className="inline-block px-3.5 py-1 text-xs font-medium tracking-wide rounded-full bg-indigo-50/80 dark:bg-indigo-950/30 text-indigo-500 dark:text-indigo-300 mb-3"
              >
                Tính năng nổi bật
              </motion.span>
              <motion.h2
                ...
                className="text-xl md:text-2xl lg:text-3xl font-bold mb-3 bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-violet-500 to-purple-500"
              >
              ...
              <motion.p
                ...
                className="max-w-2xl mx-auto text-xs sm:text-sm text-gray-500 dark:text-gray-400"
              >
          ...
          >
            <div className="relative z-10 text-center mb-10">
              <motion.span
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5 }}
                className="inline-block px-3.5 py-1 text-xs font-medium tracking-wide rounded-full bg-amber-50/80 dark:bg-amber-950/30 text-amber-600 dark:text-amber-300 mb-3"
              >
              ...
              <motion.h2
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5 }}
                className="text-xl md:text-2xl lg:text-3xl font-bold mb-3 bg-clip-text text-transparent bg-gradient-to-r from-amber-400 via-orange-500 to-amber-600"
              >
        ...
        >
          <div className="relative z-10 max-w-3xl mx-auto text-center px-4">
            <motion.h2
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
              className="text-xl md:text-2xl lg:text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-fuchsia-400 via-purple-500 to-indigo-500"
            >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5, delay: 0.2 }}
              className="mb-7 text-xs sm:text-sm text-gray-500 dark:text-gray-400 max-w-xl mx-auto"
            >
            ...
            >
              <Link href="/sign-in">
                <Button className="w-full sm:w-auto bg-gradient-to-r from-fuchsia-400 to-indigo-400 hover:from-fuchsia-500 hover:to-indigo-500 text-white rounded-full px-7 py-2.5 text-xs shadow-sm hover:shadow-fuchsia-400/20 transition-all duration-300">
                  Bắt đầu miễn phí
                </Button>
              </Link>
              <Link href="#demo">
                <Button variant="outline" className="w-full sm:w-auto rounded-full px-7 py-2.5 text-xs border-gray-200 dark:border-gray-800 bg-white/40 dark:bg-black/40 backdrop-blur-sm hover:bg-gray-50 dark:hover:bg-gray-900/50 text-gray-700 dark:text-gray-300">
                  Xem demo
                </Button>
              </Link>
            </motion.div>
        ...
        {/* Footer */}
        <footer className="py-8 px-4 border-t border-gray-100 dark:border-gray-800/50">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 dark:text-gray-500 text-xs">
              © {new Date().getFullYear()} UNIKO. Mọi quyền được bảo lưu.
            </p>
            <div className="flex items-center space-x-6 mt-4 md:mt-0">
              <a href="#" className="text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-400 text-xs">
                Điều khoản sử dụng
              </a>
              <a href="#" className="text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-400 text-xs">
                Chính sách bảo mật
              </a>
              <a href="https://github.com/auroraphtgrp01/fe-uniko" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-400 text-xs">
                GitHub
              </a>
            </div>
          </div>
