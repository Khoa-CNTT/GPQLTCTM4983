...
import { ISpendingPlan, IUpdateFundSavingPlanRequest, RecurringFrequency } from "@/core/fund-saving-plant/models"
import {
    editFundSavingPlanSchema,
    defineEditFundSavingPlanFormBody
} from "@/core/fund-saving-plant/constants/edit-fund-saving-plan.constant"
...
const EditPlanForm: React.FC<EditPlanFormProps> = ({ selectedPlan, onClose, onUpdatePlan, isLoading, isOpen }) => {
    ...
    // Debug log
    console.log("Rendering EditPlanForm with date:", defaultValues.startDate);
